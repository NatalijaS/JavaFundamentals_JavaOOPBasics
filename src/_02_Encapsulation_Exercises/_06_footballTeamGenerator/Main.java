...
public class Main {
        ...
        while (!"END".equals(input = reader.readLine())) {
            ...
            switch (command) {
                ...
                case "Remove":
                    ...
                    break;
                case "Rating":
                    printStats(tokens, teams);
                    break;
            }
        }
    }

    private static void printStats(String[] tokens, Map<String, Team> teams) {
    ...
    private static void addTeam(String[] tokens, Map<String, Team> teams) {
